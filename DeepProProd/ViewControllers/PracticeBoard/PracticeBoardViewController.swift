...
//        self.navigationItem.leftBarButtonItem = newBackButton
    ...
    func setTheme() {
        ...
        */
        ...
        contentView.layer.borderColor = UIColor.hexStringToUIColor(hex: ThemeManager.sharedInstance.backgroundColor_Regular!,alpha:1).cgColor
        
        self.view.backgroundColor = UIColor.hexStringToUIColor(hex: ThemeManager.sharedInstance.backgroundColor_Light!,alpha: 1.0)
...
//           return
    ...
    func setLineChartData(values: [Double])-> LineChartData {
        ...
        set1.setColor(UIColor.hexStringToUIColor(hex: ThemeManager.sharedInstance.backgroundColor_Regular!))
        set1.setCircleColor(UIColor.hexStringToUIColor(hex: ThemeManager.sharedInstance.backgroundColor_Regular!))
        set1.lineWidth = 4.0;
    ...
    func displayResultType(to resultType: ResultViewType  , from currentType:ResultViewType)
    {
        ...
        */
        ...
        default:
            ...
            phonemeTable.isHidden = true
            closPhonemeTableButton.isHidden = true
            showResultTypeButton.setImage(UIImage(named:"visualization"), for: .normal)
            break
        }
